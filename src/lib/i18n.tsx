...
const en: Dict = {
 ...
 "gate.warning": "Please create your identity profile and verify yourself first.",
 "gate.title": "Identity required",
 "gate.cta": "Create my identity profile",
...
const hi: Dict = {
 ...
 "gate.warning": "कृपया पहले अपनी पहचान प्रोफ़ाइल बनाएँ और स्वयं को सत्यापित करें।",
 "gate.title": "पहचान आवश्यक है",
 "gate.cta": "मेरी पहचान प्रोफ़ाइल बनाएँ",
