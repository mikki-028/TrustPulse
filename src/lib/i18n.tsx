...
const en: Dict = {
  ...
  "identity.greeting": "Hi, I'm Ramesh",
  ...
  "identity.value.name": "Ramesh Kumar",
  "identity.value.occupation": "Kirana Store Owner",
  "identity.value.location": "Jaipur, Rajasthan",
...
const hi: Dict = {
  ...
  "identity.greeting": "नमस्ते, मैं रमेश हूँ",
  ...
  "identity.value.name": "रमेश कुमार",
  "identity.value.occupation": "किराना स्टोर मालिक",
  "identity.value.location": "जयपुर, राजस्थान",
